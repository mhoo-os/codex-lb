...
- [x] 2.3 Preserve hard affinity, file ownership, request budget, account
      neutrality, and whole-session retirement on exhaustion.

## 3. Verification

- [x] 3.1 Add regressions for first-timeout recovery, telemetry-only silence,
      unsafe replay, and second-timeout settlement.
